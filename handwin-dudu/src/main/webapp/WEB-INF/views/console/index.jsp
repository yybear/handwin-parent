	...
	<div class="row">
		<div class="col-md-2">
			<ul class="nav nav-pills nav-stacked">
				<li class="active"><a href="#">未回复用户反馈</a></li>
				<li><a href="${ctx}/console/replied">已回复用户反馈</a></li>
			</ul>
		</div>
		<div class="col-md-10">
			<table class="table table-striped">
		        ...
		        <c:forEach var="fd" items="${page.list}">
			        <tr>
			            ...
			            <td>
			            	<a href="javascript:void(0);" class="replyLink" rel="${fd.columns.content}" fid="${fd.columns.id}">回复</a>&nbsp;|&nbsp;
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="saveReply" class="btn btn-primary" data-dismiss="modal">回复</button>
				</div>
			</div>
		</div>
	</div>
